    ...
    public partial class Profesores : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (miConexion != null)
                {
                    ...
                    String query = String.Format("select nombre from docentes");
        ...
        protected void ListBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (miConexion != null)
            {
                ...
                String query2 = String.Format("select * from servicios where idDocente = (select docentes.idDocente from docentes where docentes.nombre='{0}') ", ListBox1.SelectedValue);
