    ...
    public partial class Materias : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (miConexion != null)
                {
                    ...
                    String query = String.Format("select nombre from materias");
        ...
        protected void ListBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (miConexion != null)
            {
                ...
                String query2 = String.Format("select * from servicios where idMateria = (select materias.idMateria from materias where materias.nombre='{0}') ", ListBox1.SelectedValue);
