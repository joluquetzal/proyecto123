<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Materias.aspx.cs" Inherits="paginaWEBPRO.Materias" %>
    ...
    <form id="form1" runat="server">
      ...
      <nav>
          <ul class="nav_links">
              ...
              <li><asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Departamentos</asp:LinkButton></li>
